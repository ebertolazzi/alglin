...
@echo.
@powershell -command write-host -foreground "green" -background "black" -nonewline "Select Visual Studio %YEAR% %BITS%"
@echo.    
...
@IF %YEAR% == 2010  (
  ...
  @echo.
  @powershell -command write-host -foreground "red" -background "DarkGray" -nonewline "Unsupported Visual Studio %YEAR%"
  @echo.
  @EXIT
)
