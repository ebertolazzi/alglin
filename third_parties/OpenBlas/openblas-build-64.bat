...
@copy /y       %DIR64%\bin\libopenblas.dll   %BASE%\dll\openblas\libopenblas_win64.dll
@copy /y /e /t %DIR64%\include               %BASE%\include\openblas
@copy /y       %DIR64%\lib\libopenblas.a     %BASE%\lib\openblas\libopenblas_win64_static.lib
@copy /y       %DIR64%\lib\libopenblas.dll.a %BASE%\lib\openblas\libopenblas_win64.lib
