...
namespace alglin {
  ...
  */
  ...
  extern "C" {
    integer
    LAPACK_F77NAME(ilaenv)( integer * ISPEC,
                            character NAME[],
                            character OPTS[],
                            integer * N1,
                            integer * N2,
...
#include "Alglin_blas.hxx"
#include "Alglin_blas_ge.hxx"
...
namespace alglin {
  ...
  */
  ...
  { integer INFO = 0;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgttrs)( trans_blas[TRANS], &N, &NRHS, DL, D, DU, DU2, IPIV, B, &LDB, &INFO ) ;
    #elif defined(ALGLIN_USE_MKL)
  ...
  { integer INFO = 0;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgttrs)( trans_blas[TRANS], &N, &NRHS, DL, D, DU, DU2, IPIV, B, &LDB, &INFO ) ;
    #elif defined(ALGLIN_USE_MKL)
  ...
  { integer INFO = 0;
    ...
    CLAPACKNAME(dpttrs)( &N, &NRHS,
                         const_cast<doublereal*>(D), const_cast<doublereal*>(E),
                         B, &LDB, &INFO ) ;
    #else
    LAPACKNAME(dpttrs)( &N, &NRHS,
                        const_cast<doublereal*>(D), const_cast<doublereal*>(E),
                        B, &LDB, &INFO ) ;
    #endif
    return INFO ;
  ...
  */
  ...
  tbmv( ULselect      const & UPLO,
        ...
        real                xb[],
        integer             incx ) {
    #if defined(ALGLIN_USE_CBLAS) && !defined(ALGLIN_USE_OPENBLAS)
  ...
  tbsv( ULselect      const & UPLO,
    ...
    BLASNAME(dtbsv)( uplo_blas[UPLO],
                     trans_blas[TRANS],
                     diag_blas[DIAG],
               /Users/enrico/Ricerca/develop/myGitProjetcs/Alglin/src/Alglin.hh:752:12: Use of undeclared identifier 'LAPACK_NAME'      &N, &K,
                     const_cast<doublereal*>(A), &ldA, xb, &incx ) ;
    #endif
  }
  ...
  #else
    LAPACKNAME(spbtrf)( const_cast<character*>(uplo_blas[UPLO]), &N, &KD, AB, &ldAB, &info ) ;
  #endif
    return info ;
  }
  ...
  #else
    LAPACKNAME(dpbtrf)( const_cast<character*>(uplo_blas[UPLO]), &N, &KD, AB, &ldAB, &info ) ;
  #endif
    return info ;
  }
  ...
  pbtrs( ULselect const & UPLO,
    ...
    CLAPACKNAME(spbtrs)( const_cast<character*>(uplo_blas[UPLO]),
                         ...
                         const_cast<real*>(B), &ldB, &info ) ;
    #else
    LAPACKNAME(spbtrs)( const_cast<character*>(uplo_blas[UPLO]),
                        &N, &KD, &nrhs,
                        const_cast<real*>(AB), &ldAB,
                        const_cast<real*>(B), &ldB, &info ) ;
    #endif
  ...
  pbtrs( ULselect   const & UPLO,
    ...
    CLAPACKNAME(dpbtrs)( const_cast<character*>(uplo_blas[UPLO]),
                         ...
                         const_cast<doublereal*>(B), &ldB, &info ) ;
    #else
    LAPACKNAME(dpbtrs)( const_cast<character*>(uplo_blas[UPLO]),
                        &N, &KD, &nrhs,
                        const_cast<doublereal*>(AB), &ldAB,
                        const_cast<doublereal*>(B), &ldB, &info ) ;
    #endif
  ...
  */
  ...
  extern "C" {
    void
    LAPACK_F77NAME(sgetrf)( integer const * N,
                            integer const * M,
                            real            A[],
                            integer const * LDA,
                            integer         IPIV[],
                            integer       * INFO ) ;
    void
    LAPACK_F77NAME(dgetrf)( integer const * N,
                            integer const * M,
                            doublereal      A[],
                            integer const * LDA,
                            integer         IPIV[],
  ...
  { integer INFO = 0;
    ...
    //INFO = CLAPACKNAME(sgetrf)( CblasColMajor, N, M, A, LDA, IPIV ) ;
  #elif defined(ALGLIN_USE_MKL)
  ...
  { integer INFO = 0;
    ...
    //INFO = CLAPACKNAME(dgetrf)( CblasColMajor, N, M, A, LDA, IPIV ) ;
  #elif defined(ALGLIN_USE_MKL)
  ...
  */
  ...
  extern "C" {
    void
    LAPACK_F77NAME(sgetrs)( character const   TRANS[],
                            integer   const * N,
                            integer   const * NRHS,
                            real      const   A[],
                            integer   const * LDA,
                            ...
                            integer         * INFO ) ;
    void
    LAPACK_F77NAME(dgetrs)( character  const   TRANS[],
                            integer    const * N,
                            integer    const * NRHS,
                            doublereal const   A[],
                            integer    const * LDA,
  ...
  { integer INFO = 0;
    ...
    BLASFUNC(sgetrs)( const_cast<character*>(trans_blas[TRANS]),
                      ...
                      B, &LDB, &INFO ) ;
  #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgetrs)( trans_blas[TRANS], &N, &NRHS, A, &LDA, IPIV, B, &LDB, &INFO ) ;
    //INFO = CLAPACKNAME(sgetrs)( CblasColMajor, trans_cblas[TRANS],
  ...
  { integer INFO = 0;
    ...
    BLASFUNC(dgetrs)( const_cast<character*>(trans_blas[TRANS]),
                      ...
                      B, &LDB, &INFO ) ;
  #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgetrs)( trans_blas[TRANS], &N, &NRHS, A, &LDA, IPIV, B, &LDB, &INFO ) ;
    //INFO = CLAPACKNAME(dgetrs)( CblasColMajor, trans_cblas[TRANS],
    //                            N, NRHS, A, LDA, IPIV, B, LDB ) ;
  #elif defined(ALGLIN_USE_MKL)
  ...
  */
  ...
  extern "C" {
    void
    LAPACK_F77NAME(sgesv)( integer const * N,
                           integer const * NRHS,
                           real            A[],
                           integer const * LDA,
                           integer         IPIV[],
                           ...
                           integer       * INFO ) ;
    void
    LAPACK_F77NAME(dgesv)( integer const * N,
                           integer const * NRHS,
                           doublereal      A[],
                           integer const * LDA,
                           integer         IPIV[],
  ...
  { integer INFO = 0;
    ...
    //INFO = CLAPACKNAME(sgesv)( CblasColMajor, N, NRHS, A, LDA, IPIV, B, LDB ) ;
  #elif defined(ALGLIN_USE_MKL)
  ...
  { integer INFO = 0;
    ...
    //INFO = CLAPACKNAME(dgesv)( CblasColMajor, N, NRHS, A, LDA, IPIV, B, LDB ) ;
  #elif defined(ALGLIN_USE_MKL)
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(sgetc2)( integer const * N,
                            real          * A,
                            integer const * LDA,
                            integer       * IPIV,
                            integer       * JPIV,
    ...
    void
    LAPACK_F77NAME(dgetc2)( integer    const * N,
                            doublereal       * A,
                            integer    const * LDA,
                            integer          * IPIV,
                            integer          * JPIV,
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(sgecon)( character const * NORM,
                            integer   const * N,
                            real      const * A,
                            integer   const * ldA,
                            real      const * ANORM,
    ...
    void
    LAPACK_F77NAME(dgecon)( character  const * NORM,
                            integer    const * N,
                            doublereal const * A,
                            integer    const * ldA,
                            doublereal const * ANORM,
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(sgeequ)( integer const * M,
                            integer const * N,
                            real    const * A,
                            integer const * ldA,
                            real          * R,
    ...
    void
    LAPACK_F77NAME(dgeequ)( integer    const * M,
                            integer    const * N,
                            doublereal const * A,
                            integer    const * ldA,
                            doublereal       * R,
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(slaqge)( integer   const * M,
                            integer   const * N,
                            real            * A,
                            integer   const * ldA,
                            real      const * R,
    ...
    void
    LAPACK_F77NAME(dlaqge)( integer    const * M,
                            integer    const * N,
                            doublereal       * A,
                            integer    const * ldA,
                            doublereal const * R,
  ...
  laqge( integer             M,
    ...
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(slaqge)( &M, &N, A, &LDA, R, C, &ROWCND, &COLCND, &AMAX,
                            equilibrate_blas[equ] ) ;
  ...
  laqge( integer             M,
         ...
         EquilibrationType & equ ) {
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dlaqge)( &M, &N, A, &LDA, R, C, &ROWCND, &COLCND, &AMAX,
                            equilibrate_blas[equ] ) ;
  ...
  */
  ...
  extern "C" {
    ...
    LAPACK_F77NAME(slacpy)( character const   UPLO[],
                            ...
                            integer   const * LDB ) ;
    void
    LAPACK_F77NAME(dlacpy)( character  const   UPLO[],
                            integer    const * M,
                            integer    const * N,
                            doublereal const   A[],
                            integer    const * LDA,
  ...
  */
  ...
  extern "C" {
    ...
    LAPACK_F77NAME(slaset)( character const   UPLO[],
                            ...
                            integer   const * LDA ) ;
    void
    LAPACK_F77NAME(dlaset)( character  const   UPLO[],
                            integer    const * M,
                            integer    const * N,
  ...
  */
  ...
  extern "C" {
    ...
    doublereal
    LAPACK_F77NAME(dlange)( character  const   NORM[],
                            integer    const * M,
                            integer    const * N,
                            doublereal const * A,
                            integer    const * LDA,
    ...
    real
    LAPACK_F77NAME(slange)( character const   NORM[],
                            integer   const * M,
                            integer   const * N,
                            real      const * A,
                            integer   const * LDA,
  ...
  { return CLAPACKNAME(slange)( const_cast<character*>("F"), &N, &M,
                                const_cast<real*>(A), &LDA, nullptr ) ; }
  #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
  { return return_precision(LAPACK_F77NAME(slange)( "F", &N, &M, A, &LDA, nullptr )) ; }
  #elif defined(ALGLIN_USE_MKL)
  ...
  { return CLAPACKNAME(dlange)( const_cast<character*>("F"), &N, &M,
                                const_cast<doublereal*>(A), &LDA, nullptr ) ; }
  #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
  { return LAPACK_F77NAME(dlange)( "F", &N, &M, A, &LDA, nullptr ) ; }
  #elif defined(ALGLIN_USE_MKL)
  ...
  { return real(CLAPACKNAME(slange)( const_cast<character*>("M"), &N, &M,
                                     const_cast<real*>(A), &LDA, nullptr )) ; }
  #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
  { return LAPACK_F77NAME(slange)( "M", &N, &M, A, &LDA, nullptr ) ; }
  #elif defined(ALGLIN_USE_MKL)
  ...
  { return CLAPACKNAME(dlange)( const_cast<character*>("M"), &N, &M,
                                const_cast<doublereal*>(A), &LDA, nullptr ) ; }
  #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
  { return LAPACK_F77NAME(dlange)( "M", &N, &M, A, &LDA, nullptr ) ; }
  #elif defined(ALGLIN_USE_MKL)
  ...
  */
  ...
  extern "C" {
    void
    LAPACK_F77NAME(dlascl)( character  const   TYPE[],
                            integer    const * KL,
                            integer    const * KU,
    ...
    void
    LAPACK_F77NAME(slascl)( character const   TYPE[],
                            integer   const * KL,
                            integer   const * KU,
                            real      const * FROM,
                            real      const * TO,
  ...
  lascl( MatrixType const & TYPE,
    ...
    #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(slascl)( mtype_blas[TYPE],
                            &KL, &KU, &FROM, &TO, &M, &N, A, &LDA, &info) ;
    #elif defined(ALGLIN_USE_MKL)
  ...
  lascl( MatrixType const & TYPE,
    ...
    CLAPACKNAME(dlascl)( const_cast<character*>(mtype_blas[TYPE]),
                         &KL, &KU, &FROM, &TO, &M, &N, A, &LDA, &info ) ;
    #elif defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dlascl)( mtype_blas[TYPE],
                            &KL, &KU, &FROM, &TO, &M, &N, A, &LDA, &info) ;
    #elif defined(ALGLIN_USE_MKL)
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(dgeev)( character  const   jobvl[],
    ...
    void
    LAPACK_F77NAME(sgeev)( character const   jobvl[],
                           character const   jobvr[],
                           integer   const * N,
                           real            * A,
                           integer   const * LDA,
  ...
  { integer info = 0 ;
  #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgeev)( (jobvl?"V":"N"),
                           (jobvr?"V":"N"),
                           &n, A, &lda, wr, wi,
                           vl, &ldvl,
                           vr, &ldvr, work, &lwork, &info ) ;
  #elif defined(ALGLIN_USE_MKL)
    sgeev( (jobvl?"V":"N"), (jobvr?"V":"N"),
  ...
  { integer info = 0 ;
  #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgeev)( (jobvl?"V":"N"),
                           (jobvr?"V":"N"),
                           &n, A, &lda, wr, wi,
                           vl, &ldvl,
                           vr, &ldvr, work, &lwork, &info ) ;
  #elif defined(ALGLIN_USE_MKL)
    dgeev( (jobvl?"V":"N"), (jobvr?"V":"N"),
           &n, A, &lda, wr, wi, vl, &ldvl, vr, &ldvr, work, &lwork, &info ) ;
  #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(dggev)( character  const   jobvl[],
                           character  const   jobvr[],
                           integer    const * N,
                           doublereal       * A,
                           integer    const * LDA,
    ...
    void
    LAPACK_F77NAME(sggev)( character const   jobvl[],
                           character const   jobvr[],
                           integer   const * N,
                           real            * A,
                           integer   const * LDA,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sggev)( (jobvl?"V":"N"),
                           (jobvr?"V":"N"),
                           &n, A, &lda, B, &ldb, alphar, alphai, beta,
                           vl, &ldvl, vr, &ldvr, work, &lwork, &info ) ;
    #elif defined(ALGLIN_USE_MKL)
    sggev( (jobvl?"V":"N"), (jobvr?"V":"N"),
           &n, A, &lda, B, &ldb, alphar, alphai, beta,
           vl, &ldvl, vr, &ldvr, work, &lwork, &info ) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dggev)( (jobvl?"V":"N"),
                           (jobvr?"V":"N"),
                           &n, A, &lda, B, &ldb, alphar, alphai, beta,
                           vl, &ldvl, vr, &ldvr, work, &lwork, &info ) ;
    #elif defined(ALGLIN_USE_MKL)
    dggev( (jobvl?"V":"N"), (jobvr?"V":"N"),
           &n, A, &lda, B, &ldb, alphar, alphai, beta,
           vl, &ldvl, vr, &ldvr, work, &lwork, &info ) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(dggevx)(character  const   balanc[],
    ...
    void
    LAPACK_F77NAME(sggevx)(character  const   balanc[],
                           character  const   jobvl[],
                           character  const   jobvr[],
                           character  const   sense[],
                           integer    const  * N,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sggevx)( balance_blas[balanc],
                            (jobvl?"V":"N"),
                            (jobvr?"V":"N"),
                            sense_blas[sense],
                            &n,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dggevx)( balance_blas[balanc],
                            (jobvl?"V":"N"),
                            (jobvr?"V":"N"),
                            sense_blas[sense],
                            &n,
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(dgesvd)( character const   JOBU[],
    ...
    void
    LAPACK_F77NAME(sgesvd)( character const   JOBU[],
                            character const   JOBVT[],
                            integer   const * M,
                            integer   const * N,
                            real            * A,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgesvd)( job_blas[JOBU],
                            job_blas[JOBVT],
                            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT,
                            WORK, &LWORK, &info ) ;
    #elif defined(ALGLIN_USE_MKL)
    sgesvd( job_blas[JOBU], job_blas[JOBVT],
            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT,
            WORK, &LWORK, &info ) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgesvd)( job_blas[JOBU],
                            job_blas[JOBVT],
                            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT,
                            WORK, &LWORK, &info ) ;
    #elif defined(ALGLIN_USE_MKL)
    dgesvd( job_blas[JOBU], job_blas[JOBVT],
            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT,
            WORK, &LWORK, &info ) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(dgesdd)( character const   JOBZ[],
                            integer   const * M,
                            integer   const * N,
                            doublereal      * A,
                            integer   const * LDA,
    ...
    void
    LAPACK_F77NAME(sgesdd)( character const   JOBZ[],
                            integer   const * M,
                            integer   const * N,
                            real            * A,
                            integer   const * LDA,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgesdd)( job_blas[JOBZ],
                            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT, WORK, &LWORK, IWORK, &info ) ;
    #elif defined(ALGLIN_USE_MKL)
    sgesdd( job_blas[JOBZ],
            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT, WORK, &LWORK, IWORK, &info ) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgesdd)( job_blas[JOBZ],
                            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT, WORK, &LWORK, IWORK, &info ) ;
    #elif defined(ALGLIN_USE_MKL)
    dgesdd( job_blas[JOBZ],
            &M, &N, A, &LDA, S, U, &LDU, VT, &LDVT, WORK, &LWORK, IWORK, &info ) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
  ...
  */
  ...
  extern "C" {
   ...
   void
   LAPACK_F77NAME(sgelsd)( integer const * m,
                           integer const * n,
                           integer const * nrhs,
                           real    const   a[],
	                         integer const * lda,
   ...
   void
   LAPACK_F77NAME(dgelsd)( integer    const * m,
                           integer    const * n,
                           integer    const * nrhs,
                           doublereal const   a[],
	                         integer    const * lda,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgelsd)( &m, &n, &nrhs, a, &lda, b, &ldb, s, &rcond, &rank, work, &lwork, iwork, &info) ;
    #elif defined(ALGLIN_USE_MKL)
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgelsd)( &m, &n, &nrhs, a, &lda, b, &ldb, s, &rcond, &rank, work, &lwork, iwork, &info) ;
    #elif defined(ALGLIN_USE_MKL)
  ...
  */
  ...
  extern "C" {
   ...
   void
   LAPACK_F77NAME(sgelss)( integer const * m,
                           integer const * n,
                           integer const * nrhs,
                           real            a[],
	                         integer const * lda,
   ...
   void
   LAPACK_F77NAME(dgelss)( integer    const * m,
                           integer    const * n,
                           integer    const * nrhs,
                           doublereal         a[],
	                   integer    const * lda,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgelss)(&m, &n, &nrhs, a, &lda, b, &ldb, s,
                           &rcond, &rank, work, &lwork, &info);
    #elif defined(ALGLIN_USE_MKL)
    sgelss(&m, &n, &nrhs, a, &lda, b, &ldb, s,
           &rcond, &rank, work, &lwork, &info);
    #elif defined(ALGLIN_USE_ACCELERATE)
    CLAPACKNAME(sgelss)( &m, &n, &nrhs, a, &lda, b, &ldb, s,
                         &rcond, &rank, work, &lwork, &info ) ;
    #else
    LAPACKNAME(sgelss)( &m, &n, &nrhs, a, &lda, b, &ldb, s,
                        &rcond, &rank, work, &lwork, &info) ;
    #endif
    return info ;
  }
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgelss)( &m, &n, &nrhs, a, &lda, b, &ldb, s,
                            &rcond, &rank, work, &lwork, &info) ;
    #elif defined(ALGLIN_USE_MKL)
    dgelss( &m, &n, &nrhs, a, &lda, b, &ldb, s,
            &rcond, &rank, work, &lwork, &info) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
    CLAPACKNAME(dgelss)( &m, &n, &nrhs, a, &lda, b, &ldb, s,
                         &rcond, &rank, work, &lwork, &info ) ;
    #else
    LAPACKNAME(dgelss)( &m, &n, &nrhs, a, &lda, b, &ldb, s,
                        &rcond, &rank, work, &lwork, &info) ;
    #endif
    return info ;
  }
  ...
  */
  ...
  extern "C" {
   ...
   void
   LAPACK_F77NAME(sgelsy)( integer const * m,
                           integer const * n,
                           integer const * nrhs,
                           real            a[],
	                         integer const * lda,
   ...
   void
   LAPACK_F77NAME(dgelsy)( integer    const * m,
                           integer    const * n,
                           integer    const * nrhs,
                           doublereal         a[],
	                         integer    const * lda,
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(sgelsy)(&m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
                           &rcond, &rank, work, &lwork, &info);
    #elif defined(ALGLIN_USE_MKL)
    sgelsy(&m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
           &rcond, &rank, work, &lwork, &info);
    #elif defined(ALGLIN_USE_ACCELERATE)
    CLAPACKNAME(sgelsy)( &m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
                         &rcond, &rank, work, &lwork, &info ) ;
    #else
    LAPACKNAME(sgelsy)( &m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
                        &rcond, &rank, work, &lwork, &info) ;
    #endif
    return info ;
  }
  ...
  { integer info = 0 ;
    #if defined(ALGLIN_USE_LAPACK) || defined(ALGLIN_USE_OPENBLAS) || defined(ALGLIN_USE_ATLAS)
    LAPACK_F77NAME(dgelsy)( &m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
                            &rcond, &rank, work, &lwork, &info) ;
    #elif defined(ALGLIN_USE_MKL)
    dgelsy( &m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
            &rcond, &rank, work, &lwork, &info) ;
    #elif defined(ALGLIN_USE_ACCELERATE)
    CLAPACKNAME(dgelsy)( &m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
                         &rcond, &rank, work, &lwork, &info ) ;
    #else
    LAPACKNAME(dgelsy)( &m, &n, &nrhs, a, &lda, b, &ldb, jpvt,
                        &rcond, &rank, work, &lwork, &info) ;
    #endif
    return info ;
  }
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(slaic1)( integer * JOB,
                            integer * J,
                            real      X[],
                            real    * SEST,
                            real      W[],
    ...
    void
    LAPACK_F77NAME(dlaic1)( integer    * JOB,
                            integer    * J,
                            doublereal   X[],
                            doublereal * SEST,
                            doublereal   W[],
