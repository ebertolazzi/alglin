...
namespace alglin {
  ...
  */
  ...
  extern "C" {
    void
    BLASFUNC(sgemv)( character const   TRANS[],
                     integer   const * M,
                     integer   const * N,
                     real      const * ALPHA,
                     real      const   A[],
                     ...
                     integer   const * INCY ) ;
    void
    BLASFUNC(dgemv)( character  const   TRANS[],
                     integer    const * M,
                     integer    const * N,
                     doublereal const * ALPHA,
                     doublereal const   A[],
  ...
  */
  ...
  extern "C" {
    void
    BLASFUNC(sgemm)( character const   TRANSA[],
                     ...
                     integer   const * LDC ) ;
    void
    BLASFUNC(dgemm)( character  const   TRANSA[],
                     character  const   TRANSB[],
                     integer    const * M,
                     integer    const * N,
                     integer    const * K,
  ...
  */
  ...
  extern "C" {
    void
    BLASFUNC(sgetrf)( integer const * N,
                      integer const * M,
                      real            A[],
                      integer const * LDA,
                      integer         IPIV[],
                      integer       * INFO ) ;
    void
    BLASFUNC(dgetrf)( integer const * N,
                      integer const * M,
                      doublereal      A[],
                      integer const * LDA,
                      integer         IPIV[],
  ...
  */
  ...
  extern "C" {
    void
    BLASFUNC(sgetrs)( character const   TRANS[],
                      integer   const * N,
                      integer   const * NRHS,
                      real      const   A[],
                      integer   const * LDA,
                      ...
                      integer         * INFO ) ;
    void
    BLASFUNC(dgetrs)( character  const   TRANS[],
                      integer    const * N,
                      integer    const * NRHS,
                      doublereal const   A[],
                      integer    const * LDA,
  ...
  */
  ...
  extern "C" {
    void
    BLASFUNC(sgesv)( integer const * N,
                     integer const * NRHS,
                     real            A[],
                     integer const * LDA,
                     integer         IPIV[],
                     ...
                     integer       * INFO ) ;
    void
    BLASFUNC(dgesv)( integer const * N,
                     integer const * NRHS,
                     doublereal      A[],
                     integer const * LDA,
                     integer         IPIV[],
  ...
  */
  ...
  extern "C" {
    ...
    void
    LAPACK_F77NAME(sgesc2)( integer const * N,
                            real          * A,
                            integer const * LDA,
                            real          * RHS,
                            integer const * IPIV,
    ...
    void
    LAPACK_F77NAME(dgesc2)( integer const * N,
                            doublereal    * A,
                            integer const * LDA,
                            doublereal    * RHS,
                            integer const * IPIV,
