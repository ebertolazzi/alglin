...
namespace alglin {
  ...
  public:
    ...
    BandedLU();
    virtual ~BandedLU() ALGLIN_OVERRIDE;
  ...
  public:
    ...
    virtual
    void
    update( valueType const y[],
            valueType const s[] ) ALGLIN_PURE_VIRTUAL;
  ...
  public:
    ...
    void
    update( valueType const y[],
            valueType const s[] ) ALGLIN_OVERRIDE;
